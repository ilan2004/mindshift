...
// Individual personality type themes
export const MBTI_THEMES = {
  ...
  INTJ: {
    ...
    name: 'The Architect',
    colors: {
      primary: { light: '#6366F1', dark: '#8B5CF6' }, // Indigo-Purple
      secondary: { light: '#3B82F6', dark: '#60A5FA' }, // Blue
      accent: { light: '#8B5CF6', dark: '#A78BFA' }, // Purple
      background: { 
        light: 'from-indigo-50 via-slate-50 to-purple-50', 
        dark: 'from-indigo-900 via-slate-900 to-purple-900' 
      },
      surface: { 
        light: 'bg-gradient-to-br from-white/90 to-indigo-50/90 border-indigo-200', 
        dark: 'bg-gradient-to-br from-slate-800/90 to-purple-900/50 border-purple-500/30' 
      },
      progress: { light: 'from-indigo-500 to-purple-500', dark: 'from-indigo-400 to-purple-400' },
      icon: '🏗️',
  ...
  INTP: {
    ...
    name: 'The Thinker',
    colors: {
      primary: { light: '#06B6D4', dark: '#67E8F9' }, // Cyan
      secondary: { light: '#3B82F6', dark: '#60A5FA' }, // Blue
      accent: { light: '#0EA5E9', dark: '#38BDF8' }, // Sky
      background: { 
        light: 'from-cyan-50 via-blue-50 to-slate-50', 
        dark: 'from-cyan-900 via-blue-900 to-slate-900' 
      },
      surface: { 
        light: 'bg-gradient-to-br from-white/90 to-cyan-50/90 border-cyan-200', 
        dark: 'bg-gradient-to-br from-slate-800/90 to-blue-900/50 border-cyan-500/30' 
      },
      progress: { light: 'from-cyan-500 to-blue-500', dark: 'from-cyan-400 to-blue-400' },
      icon: '🔍',
